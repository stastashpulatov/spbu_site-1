...
const translations: Translations = {
  ru: {
    ...
    sections: [
      ...
      { title: 'Руководство. Педагогический состав', link: '/branch-tashkent/sveden/employees' },
  ...
  uz: {
    ...
    sections: [
      ...
      { title: 'Rahbariyat. Pedagogik tarkib', link: '/branch-tashkent/sveden/employees' },
  ...
  en: {
    ...
    sections: [
      ...
      { title: 'Leadership. Teaching staff', link: '/branch-tashkent/sveden/employees' },
